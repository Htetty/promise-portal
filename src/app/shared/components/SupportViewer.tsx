  ...
  return (
    <>
      <button
        ...
        className="text-xs sm:text-sm lg:text-md text-[black] relative after:bg-[#FDD06E] after:absolute after:h-1 after:w-0 after:bottom-0 after:left-0 hover:after:w-full after:transition-all after:duration-300 cursor-pointer"
      >
        What does this mean?
      </button>
